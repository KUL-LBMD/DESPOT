...
if __name__ == '__main__':
	basename_list = [x[:-5] for x in os.listdir(f'{DATA_DIR}/CROWN/processed_mol2/receptor')]
	list_of_dicts = Parallel(n_jobs = 1, verbose = 10)(delayed(process_file)(subdir) for subdir in basename_list)
