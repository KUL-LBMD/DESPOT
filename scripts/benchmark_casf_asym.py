...
from src.casf.run_despot_asym import run_scoring, run_docking, run_screening
...
NAME_LIST = [
    'despot_crown_druglike_min_asym', 'despot_iso_crown_druglike_min_asym', 'despot_crown_druglike_min', 'despot_iso_crown_druglike_min',
...
NAME_LIST_CLEAN = [
    'DESPOT-asym', 'DESPOT-Iso-asym', 'DESPOT-min', 'DESPOT-Iso-min',
