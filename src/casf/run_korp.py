...
def run_scoring(database):
	scorer1 = KORP_Scorer(norm_mode = 'normed_scores', database = database) # DESPOT
	scorer2 = KORP_Scorer(norm_mode = 'scores', database = database) # DESPOT
	...
	df1.to_csv(f'{DATA_DIR}/CASF-2016/benchmark_results/korp_normed_{database.lower()}_scorepower.csv', index = False, float_format = '%.4f')
	df2.to_csv(f'{DATA_DIR}/CASF-2016/benchmark_results/korp_{database.lower()}_scorepower.csv', index = False, float_format = '%.4f')
...
def run_docking(database):
	...
	df1.to_csv(f'{DATA_DIR}/CASF-2016/benchmark_results/korp_normed_{database.lower()}_dockingpower.csv', index = False, float_format = '%.4f')
	df2.to_csv(f'{DATA_DIR}/CASF-2016/benchmark_results/korp_{database.lower()}_dockingpower.csv', index = False, float_format = '%.4f')
